...
// ---------------------------------------------------------------------------
// Tests unitaires PersonRepositoryImpl
// ---------------------------------------------------------------------------
void main() {
  ...
  group('PersonRepositoryImpl - getAllPerson', () {
    test(
      '1. Succès réseau : retourne les personnes distantes et les sauvegarde en cache SQLite',
      () async {
    ...
    test(
      '2. Échec réseau (mode hors-ligne) : retourne les personnes du cache local SQLite',
      () async {
    ...
    test(
      '3. Échec réseau sans cache local : convertit DioException en NetworkException',
      () async {
  ...
  group('PersonRepositoryImpl - getPersonById', () {
    test(
      '4. Succès réseau : retourne la personne et la persiste en local',
      () async {
    ...
    test(
      '5. Échec réseau : retourne la personne depuis le cache local SQLite',
      () async {
        final person = samplePersons.first;
